...
[![ClawdHub](https://img.shields.io/badge/ClawdHub-mineru--pdf--parser--clawdbot--skill-blue)](https://clawdhub.com/skill/mineru-pdf-parser-clawdbot-skill)
[![Version](https://img.shields.io/badge/Version-1.0.0-green)](https://clawdhub.com/skill/mineru-pdf-parser-clawdbot-skill)
...
[MinerU](https://github.com/opendatalab/MinerU) is an open-source PDF parsing powerhouse developed by OpenDataLab. It combines multiple AI models for end-to-end document understanding:

- **Layout analysis** — Identifies sections, figures, tables, and reading order
- **OCR (Optical Character Recognition)** — Extracts text from scanned documents
- **Table recognition** — Detects and reconstructs table structures
- **Multi-language support** — Processes 80+ languages including English, Chinese, Japanese

### Why MinerU?

| Challenge | MinerU Solution |
|-----------|-----------------|
| Scanned PDFs | Built-in OCR (OCR-free mode available for digital PDFs) |
| Complex layouts | Layout analysis maintains reading order and structure |
| Tables | Dedicated table detection and extraction |
| Images/Charts | Automatic image extraction with caption matching |
| Mixed content | Unified pipeline handles text + images + tables |

Compared to basic PDF parsers (like PyMuPDF), MinerU provides:
- **10-100x more accurate** text extraction on complex documents
- **Layout preservation** that keeps headings, columns, and figures in context
- **Structure-rich JSON** with bounding boxes, types, and relationships
